...
const DID='did:hive:hiveforce-legalreview';const ID={name:'HiveForce-LegalReview',purpose:'Contract analysis and legal review — risk scoring, clause detection, regulatory mapping',capabilities:["contract_analysis","risk_scoring","clause_detection","regulatory_mapping"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-legal-review',purpose:ID.purpose})}
